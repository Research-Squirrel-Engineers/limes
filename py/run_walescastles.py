...
file_in = dir_path.replace("\\py","\\csv") + "\\" + "WalesCastles.csv"
file_out = dir_path.replace("\\py","\\geojson") + "\\" + "WalesCastles.geojson"
...
data = pd.read_csv(
    ...
    usecols=['name','lat','long'], # only load the  columns specified
