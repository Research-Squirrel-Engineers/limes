...
file_in = dir_path.replace("\\py","\\csv") + "\\" + "LimesPannoniaSuperior.csv"
file_out = dir_path.replace("\\py","\\geojson") + "\\" + "LimesPannoniaSuperior.geojson"
...
data = pd.read_csv(
    ...
    usecols=['name','typ','typ2','lat','long'], # only load the  columns specified
